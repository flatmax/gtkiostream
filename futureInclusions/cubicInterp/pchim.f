...
C                          $Id: pchim.f,v 1.1 1997/02/14 14:13:13 ulammers Exp $
C                          $Source: /usr4/users/aparmar/SAXDAS/pipeline/LE_lemat/RCS/pchim.f,v $
c
c     --- SLATEC ROUTINES ---------------------------------------------
c
c       PCHIM
...
c       CHFEV
c
c       XERMSG - this is a subsidiary routine used by all the above to
c                output error messages. Here it simply calls FTOOL's
c                FCERR.
c     -----------------------------------------------------------------
c
*DECK PCHIM
